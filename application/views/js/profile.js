   ...
   {
      var subscribe = "0";
      if (document.getElementsByName("q_subscribe")[0].checked)
      {
        subscribe = "1";
      }
      ...
      xmlhttp.open("POST", $("#base-url").html() + "index.php/members/save_subscribe_ajax", true);  
      xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
   
      args = "q_subscribe=" + subscribe;
